...
function core.step()
  ...
  for type, a,b,c,d,e,f in system.poll_event do
    ...
    if type == "mousemoved" or type == "mousepressed" then
      win_id = e
    elseif type == "mousereleased" or type == "textediting" or type == "touchpressed" or type == "touchreleased" or type == "filedropped" then
      win_id = d
    elseif type == "mousewheel" or type == "resized" then
      win_id = c
    elseif type == "keypressed" or type == "keyreleased" or type == "textinput" then
      win_id = b
    elseif type == "exposed" or type == "minimized" or type == "maximized" or type == "restored" or type == "mouseleft" or type == "focuslost" then
      win_id = a
    elseif type == "touchmoved" then
      win_id = f
    end
