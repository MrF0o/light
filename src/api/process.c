...
static int f_process_kill_list_gc(lua_State *L) {
  process_kill_list_t *list = (process_kill_list_t *) lua_touserdata(L, 1);
...
int luaopen_process(lua_State *L) {
  ...
  lua_newtable(L);
  lua_pushcfunction(L, f_process_kill_list_gc);
